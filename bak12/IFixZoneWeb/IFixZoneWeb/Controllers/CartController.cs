...
{
    // [Authorize]  <-- REMOVED CLASS LEVEL
    public class CartController : Controller
    {
        private readonly AppDbContext _context;
        // private readonly IViewRenderService _viewRender; <-- REMOVED UNUSED
        ...
        // 👀 XEM GIỎ HÀNG
        // =====================================================
        [Authorize] // 🔐 Added explicit authorize
        ...
        public async Task<IActionResult> AddToCart(int productId, int quantity = 1)
        {
            ...
            {
                success = true,
                quantity = cart.CartItems.Sum(x => x.Quantity), // tổng số lượng
                itemCount = cart.CartItems.Count               // số loại sản phẩm
            });
        }
